        ...
        <div className="prose prose-zinc dark:prose-invert max-w-none">
          ...
          <section className="mb-8">
            ...
            <p className="text-zinc-700 dark:text-zinc-300">
              By accessing and using ValidNames.com, you agree to be bound by
          ...
          <section className="mb-8">
            ...
            <p className="text-zinc-700 dark:text-zinc-300">
              ValidNames.com provides domain name availability checking
              services. We query public WHOIS databases to provide information
              about domain name availability and registration status.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-zinc-700 dark:text-zinc-300">
              To the maximum extent permitted by law, ValidNames.com and its
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 text-zinc-700 dark:text-zinc-300">
              <li>
                Domain checking is performed against public WHOIS databases
              </li>
              <li>WHOIS information is provided by third-party registries</li>
              <li>We are not responsible for the accuracy of WHOIS data</li>
              <li>
                WHOIS data may be subject to registry policies and restrictions
              </li>
            </ul>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-zinc-700 dark:text-zinc-300">
              The ValidNames.com website and service are owned by Garun Vagidov.
              All rights reserved. Users are granted a limited license to use
          ...
          <section className="mb-8">
            ...
            <p className="text-zinc-700 dark:text-zinc-300">
              This service is hosted on Vercel. Performance monitoring is
              conducted using Vercel Analytics and Speed Insights to ensure
